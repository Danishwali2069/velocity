...
const STATIC_CARS = [
  {
    ...
    price: 129900, image: audiImg, badge: 'Featured', category: 'sports',
    colors: ['#c0c0c0', '#1a1a1a', '#b8860b'], rating: 4.9, reviewCount: 128,
  ...
  },
  {
    ...
    price: 84900, image: bmwImg, badge: 'Best Seller', category: 'sports',
    colors: ['#1a3a6b', '#fff', '#0d0d0d'], rating: 4.8, reviewCount: 256,
  ...
  },
  {
    ...
    price: 212000, image: nissanImg, badge: 'Rare', category: 'supercar',
    colors: ['#e8e8e8', '#cc0000', '#1a1a1a'], rating: 5.0, reviewCount: 89,
  ...
  },
  {
    ...
    price: 243800, image: porscheImg, badge: 'Limited', category: 'track',
    colors: ['#cc0000', '#ff6600', '#1a1a1a'], rating: 5.0, reviewCount: 67,
  ...
  },
  {
    ...
    price: 58900, image: supraImg, badge: 'New', category: 'sports',
    colors: ['#ff6600', '#cc0000', '#ffd700'], rating: 4.7, reviewCount: 312,
